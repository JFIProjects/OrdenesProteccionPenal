<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Aspirantes.Clases.Login" %>
            ...
            <ContentTemplate>
                <asp:Panel runat="server" CssClass="central_panel p-4">
                    ...
                    <asp:Panel runat="server" CssClass="row m-0">
                        <asp:Label runat="server" CssClass="titulo_central_panel text-center font-weight-bold" style="margin: 0 auto;"> SISTEMA DE MERITORIOS</asp:Label>
                    </asp:Panel>
                    <asp:Panel runat="server" CssClass="row m-0">
